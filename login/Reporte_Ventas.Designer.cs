namespace login
{
    partial class Reporte_Ventas
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DSVentas = new login.DSVentas();
            this.DataTable1BindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.DataTable1TableAdapter = new login.DSVentasTableAdapters.DataTable1TableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "login.Reporte_venta.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(675, 371);
            ...
            this.DataTable1BindingSource.DataSource = this.DSVentas;
            // 
        ...
        private DSVentasTableAdapters.DataTable1TableAdapter DataTable1TableAdapter;
    }
}